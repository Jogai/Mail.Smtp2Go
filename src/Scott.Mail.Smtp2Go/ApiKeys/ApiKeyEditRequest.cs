...
/// <summary>The body of <c>POST /api_keys/edit</c>: a full edit. Fields you omit fall back to the documented defaults (for example <c>status</c> to <c>allowed</c>, the tracking flags to <see langword="false"/>). <c>subaccount_id</c> is injected from <see cref="RequestOptions.SubaccountId"/>.</summary>
[Smtp2GoEndpoint("api_keys/edit")]
public sealed record ApiKeyEditRequest : IRequestValidator
{
