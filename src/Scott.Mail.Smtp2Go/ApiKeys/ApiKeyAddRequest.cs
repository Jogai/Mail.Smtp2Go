...
/// <summary>The body of <c>POST /api_keys/add</c>. Every field is optional; the docs give the server defaults. <c>subaccount_id</c> is injected from <see cref="RequestOptions.SubaccountId"/>.</summary>
[Smtp2GoEndpoint("api_keys/add")]
public sealed record ApiKeyAddRequest : IRequestValidator
{
