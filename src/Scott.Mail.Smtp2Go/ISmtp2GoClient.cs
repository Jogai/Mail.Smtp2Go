...
{
    // One property per API family, in the order of architecture.md section 3.1; Raw reaches any endpoint by path.
    ...
    /// <summary>Allowed recipients: <c>allowed_recipients/view</c>, <c>add</c>, <c>remove</c>, <c>update</c>.</summary>
    IAllowedRecipientClient AllowedRecipients { get; }
    ...
    /// <summary>SMS: <c>sms/send</c>, <c>sms/summary</c>, <c>sms/view-received</c>, <c>sms/view-sent</c>.</summary>
    ISmsClient Sms { get; }
