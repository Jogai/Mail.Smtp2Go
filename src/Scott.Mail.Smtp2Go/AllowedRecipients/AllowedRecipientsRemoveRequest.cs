...
/// <summary>The body of <c>POST /allowed_recipients/remove</c>. <c>subaccount_id</c> is injected from <see cref="RequestOptions.SubaccountId"/>.</summary>
[Smtp2GoEndpoint("allowed_recipients/remove")]
public sealed record AllowedRecipientsRemoveRequest : IRequestValidator
{
