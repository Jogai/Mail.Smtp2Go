...
/// <summary>The body of <c>PATCH /users/smtp/edit</c>: a partial edit. Omitted fields are left unchanged. Same shape as <see cref="SmtpUserEditRequest"/>; the client sends it with <c>PATCH</c>.</summary>
[Smtp2GoEndpoint("users/smtp/edit")]
public sealed record SmtpUserPatchRequest : IRequestValidator
{
